...
class TestTargetAcquisition:
    ...
    def test_find_all_targets(self, data_dir):
        ...
        found_files = set(itertools.chain(extracted_files))

        assert found_files == scraper.scrape.StartURLs(extracted_files).urls
    ...
    def test_files_mapped_to_correct_open_func(self, data_dir):
        ...
        # TODO: try actually verifying the content of these small files
